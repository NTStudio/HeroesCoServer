                                ...
                                if (C.Loc.Map == Owner.Loc.Map && C.Loc.MapCopy == Owner.Loc.MapCopy)
                                {
                                    if ( MyMath.PointDistance(C.Loc.X, C.Loc.Y, Owner.Loc.X, Owner.Loc.Y) <= 14)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else if (MyMath.PointDistance(C.Loc.X, C.Loc.Y, Owner.Loc.X, Owner.Loc.Y) > 4 && DateTime.Now >= C.LastWalk.AddMilliseconds(C.WalkSpeed) && DateTime.Now >= C.LastJump.AddMilliseconds(300))
                                            {
